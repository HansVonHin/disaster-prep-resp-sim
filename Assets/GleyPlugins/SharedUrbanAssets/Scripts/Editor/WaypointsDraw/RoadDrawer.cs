            ...
            for (int i = 0; i < path.NumPoints; i++)
            {
                ...
                switch (moveTool)
                {
                    ...
                    case MoveTools.Move2D:
                        var fmh_72_96_638668114662472215 = Quaternion.identity; newPos = Handles.FreeMoveHandle(path.GetPoint(i, road.positionOffset), handleSize, Vector2.zero, Handles.SphereHandleCap);
